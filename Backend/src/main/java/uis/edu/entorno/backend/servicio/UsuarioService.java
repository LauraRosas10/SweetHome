...
public class UsuarioService implements IUsuarioService {
    ...
    // Guardar cambios de usuario existente (editar)
	...
	public Usuario loginReturnUser(LoginDto usuarioDto) {
	    return usuarioRepositorio.findByNameAndPassword(usuarioDto.getEmail(), usuarioDto.getContraseña());
	}
